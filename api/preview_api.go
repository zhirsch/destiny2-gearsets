...
func (a *PreviewApiService) Destiny2ActivateTalentNode(ctx context.Context, ) (InlineResponse20015,  *http.Response, error) {
	var (
...
func (a *PreviewApiService) Destiny2GetActivityHistory(characterId int64, destinyMembershipId int64, membershipType int32, localVarOptionals map[string]interface{}) (InlineResponse20045,  *http.Response, error) {
	var (
...
func (a *PreviewApiService) Destiny2GetClanAggregateStats(groupId int64, localVarOptionals map[string]interface{}) (InlineResponse20041,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
func (a *PreviewApiService) Destiny2GetClanLeaderboards(groupId int64, localVarOptionals map[string]interface{}) (InlineResponse20040,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
func (a *PreviewApiService) Destiny2GetDestinyAggregateActivityStats(characterId int64, destinyMembershipId int64, membershipType int32) (InlineResponse20047,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
func (a *PreviewApiService) Destiny2GetHistoricalStats(characterId int64, destinyMembershipId int64, membershipType int32, localVarOptionals map[string]interface{}) (InlineResponse20043,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
func (a *PreviewApiService) Destiny2GetHistoricalStatsForAccount(destinyMembershipId int64, membershipType int32, localVarOptionals map[string]interface{}) (InlineResponse20044,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
/* PreviewApiService 
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "statid" (string) ID of stat to return rather than returning all Leaderboard stats.
 @return InlineResponse20040*/
func (a *PreviewApiService) Destiny2GetLeaderboards(destinyMembershipId int64, membershipType int32, localVarOptionals map[string]interface{}) (InlineResponse20040,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
/* PreviewApiService 
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "statid" (string) ID of stat to return rather than returning all Leaderboard stats.
 @return InlineResponse20040*/
func (a *PreviewApiService) Destiny2GetLeaderboardsForCharacter(characterId int64, destinyMembershipId int64, membershipType int32, localVarOptionals map[string]interface{}) (InlineResponse20040,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
func (a *PreviewApiService) Destiny2GetUniqueWeaponHistory(characterId int64, destinyMembershipId int64, membershipType int32) (InlineResponse20046,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
func (a *PreviewApiService) Destiny2GetVendor(characterId int64, destinyMembershipId int64, membershipType int32, vendorHash int32, localVarOptionals map[string]interface{}) (InlineResponse20036,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
func (a *PreviewApiService) Destiny2GetVendors(characterId int64, destinyMembershipId int64, membershipType int32, localVarOptionals map[string]interface{}) (InlineResponse20035,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context Authentication Context 
 @return InlineResponse20015*/
func (a *PreviewApiService) Destiny2InsertSocketPlug(ctx context.Context, ) (InlineResponse20015,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
...
func (a *PreviewApiService) Destiny2SearchDestinyEntities(searchTerm string, type_ string, localVarOptionals map[string]interface{}) (InlineResponse20042,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
