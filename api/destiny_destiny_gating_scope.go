...
const (
	DestinyDestinyGatingScope_0 DestinyDestinyGatingScope = 0
	DestinyDestinyGatingScope_1 DestinyDestinyGatingScope = 1
	DestinyDestinyGatingScope_2 DestinyDestinyGatingScope = 2
	DestinyDestinyGatingScope_3 DestinyDestinyGatingScope = 3
	DestinyDestinyGatingScope_4 DestinyDestinyGatingScope = 4
	DestinyDestinyGatingScope_5 DestinyDestinyGatingScope = 5
	DestinyDestinyGatingScope_6 DestinyDestinyGatingScope = 6
)
