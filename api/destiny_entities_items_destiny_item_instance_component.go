...
type DestinyEntitiesItemsDestinyItemInstanceComponent struct {
	...
	DamageType *interface{} `json:"damageType,omitempty"`
	// The current damage type's hash, so you can look up localized info and icons for it.
	DamageTypeHash int64 `json:"damageTypeHash,omitempty"`
	...
	PrimaryStat *interface{} `json:"primaryStat,omitempty"`
	...
	UnlockHashesRequiredToEquip []int64 `json:"unlockHashesRequiredToEquip,omitempty"`
	...
	CannotEquipReason *interface{} `json:"cannotEquipReason,omitempty"`
}
